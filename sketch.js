...
function draw() {
  ...
  if (gameState==="wait"){
    ...
    fill("white")
    textSize(40)
    text("Kill your fears, before they kill you", 530,100)
    textSize(30)
    text("Are you ready to overcome your fears?", 570,400)
    text("If yes click on the button",660,500)
...
textSize(30)
fill("white")
text("Score: "+score,displayWidth-5, 50)
